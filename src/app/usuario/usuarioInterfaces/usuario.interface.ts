...
export class Convert {
    public static toUsuarioInterface(json: string): UsuarioInterface {
        return cast(JSON.parse(json), r("UsuarioInterface"));
    }

    public static usuarioInterfaceToJson(value: UsuarioInterface): string {
        return JSON.stringify(uncast(value, r("UsuarioInterface")), null, 2);
    }
}
