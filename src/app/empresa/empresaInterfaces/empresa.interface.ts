...
export class Convert {
    public static toEmpresaInterface(json: string): EmpresaInterface[] {
        return cast(JSON.parse(json), a(r("EmpresaInterface")));
    }

    public static empresaInterfaceToJson(value: EmpresaInterface[]): string {
        return JSON.stringify(uncast(value, a(r("EmpresaInterface"))), null, 2);
    }
}
...
const typeMap: any = {
    "EmpresaInterface": o([
        ...
        { json: "departamento", js: "departamento", typ: "" },
